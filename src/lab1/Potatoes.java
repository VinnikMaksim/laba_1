...
// типов (Шаг 2) и совпадение размеров (Шаг 3)
    public boolean equals(Object arg0) {
        if (super.equals(arg0)) { // Шаг 1
            if (!(arg0 instanceof Potatoes)) return false; // Шаг 2
            return type.equals(((Potatoes)arg0).type); // Шаг 3
        } else
            return false;
    }
...
// название продукта, но и его размер
    public String toString() {
        return super.toString() + " способа приготовления '" + type.toUpperCase() + "'";
    }
}