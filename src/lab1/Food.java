...
// Наш класс абстрактный так как мы имплимитируем в него интерфейс КОНСУМЭЙБЛ
// Чтобы класс стал не абстрактным, убираем клбч слово и реализуем метод consume()
